...
1. A model, in which you have to set the condition for the badge to be earn
2. An observer, which you can destroy or modify to observe a model to award a badge
3. A test file to test the model. 
